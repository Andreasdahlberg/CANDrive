...
{
    check_expected_uint(nr);
    check_expected_uint(id1);
    check_expected_uint(mask1);
    check_expected_uint(id2);
    check_expected_uint(mask2);
}
